-- Restore essential trigger for user signup
-- This recreates the minimal functionality needed for user registration

-- First recreate the update_updated_at_column function
