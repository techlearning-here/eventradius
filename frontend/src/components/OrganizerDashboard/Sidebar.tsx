...
import { Home, LogOut, CalendarDays, BarChart3, Users, Megaphone, CreditCard, FileText, Settings, HelpCircle, Trash2, ChevronLeft, ChevronRight, ClipboardCheck, Tag } from 'lucide-react';
...
const sidebarItems: SidebarItem[] = [
  ...
  { id: 'pricing', label: 'Dynamic Pricing', icon: Tag, color: 'text-indigo-600', bgColor: 'bg-indigo-100' },
