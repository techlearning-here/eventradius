...
import { FileText, Clock, MapPin, Settings, Eye, TrendingUp, Share2, Star, Users } from 'lucide-react';
...
export const SidePanel = ({ activeSection, onSectionChange }: SidePanelProps) => {
  return (
