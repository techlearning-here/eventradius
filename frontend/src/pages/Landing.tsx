    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-4 md:px-8 py-6 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-semibold tracking-tight text-foreground">Event Pinger</span>
        </div>
        {user ? (
          <button
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="relative overflow-hidden rounded-lg">
            ...
            <img src="/your-image.jpg" alt="Event Pinger" className="w-full h-auto object-cover" />
