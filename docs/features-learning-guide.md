...
This document distills **`Feature_plan.md`** (product vision, categories, future verticals) and **`Website_Prompt.md`** (functional spec for “Event Pinger” / EventRadius). Use it to learn what the product is meant to do and how pieces fit together.
