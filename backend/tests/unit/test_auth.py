...
from config.auth import AuthService, OptionalHTTPBearer, security, optional_auth, require_auth, require_admin, get_current_user, get_current_admin
...
class TestOptionalHTTPBearer:
    ...
    async def test_optional_http_bearer_no_token(self):
        ...
        assert bearer.__doc__ == "Custom HTTPBearer that doesn't auto-raise on missing credentials"
...
class TestAuthService:
    ...
    def test_verify_token_valid(self):
        ...
        test_payload = {"sub": "user123", "email": "test@example.com", "exp": datetime.utcnow() + timedelta(hours=1)}
    ...
    def test_require_auth_valid(self):
        ...
        with patch.object(self.auth_service, 'get_current_user', return_value={"id": "user123", "role": "authenticated"}):
    ...
    def test_require_admin_admin_user(self):
        ...
        with patch.object(self.auth_service, 'get_current_user', return_value={"id": "admin123", "role": "admin"}):
