...
print("Testing participate_event endpoint...")
print(f"Mock user: {mock_user}")
print(f"Mock event organizer_id: {mock_event['organizer_id']}")
print(f"Mock event is_public: {mock_event['is_public']}")
            ...
            with patch("api.events.update_record") as mock_update:
                ...
                with patch("api.events.get_table") as mock_get_table:
                    ...
                    if mock_get_table.called:
                        ...
                        print(f"  get_table call args: {mock_get_table.call_args}")
